          ...
          children: [
            Image.network(
              ...
              errorBuilder: (context, error, stackTrace) {
                return Image.asset('assets/images/arduino.png', height: 200);
              },
            ),
            ...
            ElevatedButton(
              onPressed: () {
                Provider.of<ComponentProvider>(context, listen: false)
                    .updateComponentQuantity(widget.component.id, _currentQuantity);
